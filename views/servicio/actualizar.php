...
<form class="flex flex-col" method="POST">
    <h2 class="text-center text-3xl font-bold mb-3 text-purple-700">Actualizar Servicio</h2>
    <?php include_once __DIR__  . '/form.php'; ?>
    <input type="submit" value="Actualizar" class="bg-purple-700 rounded-xl text-white hover:bg-purple-900 mt-5 p-2 cursor-pointer" >
</form>
</div>
<?php
