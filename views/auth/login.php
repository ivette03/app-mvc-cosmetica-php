...
<div class="flex justify-center items-center h-screen">
    ...
    ?>
        <h3 clasS="text-center font-bold text-purple-800 text-3xl py-8">Inicio de sesión</h3>
        <div class="mb-4">
            <label class="block text-purple-700 text-sm font-bold mb-2" for="email">
                Email
            </label>
            <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="username" type="text" placeholder="email" name="email"  value="<?php '' ?? htmlspecialchars($_POST['email']);?>">
        </div>
        <div class="mb-6">
